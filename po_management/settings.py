...
MIDDLEWARE = [
    ...
    'po_system.middleware.LoginRequiredMiddleware',  # Custom middleware for login required
]
...
LOGIN_URL = 'po_system:login'
LOGIN_REDIRECT_URL = 'po_system:dashboard'
LOGOUT_REDIRECT_URL = 'po_system:login'
