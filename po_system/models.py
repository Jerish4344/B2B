# TEMPORARY MODELS.PY FOR CLEAN MIGRATION
# Use this version first, then update to full version after initial migration
...
class Product(models.Model):
    ...
    proposed_price = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(Decimal('0.01'))])
    proposed_stock = models.IntegerField(validators=[MinValueValidator(0)])
